...
namespace MGSharp.Core.GeometricPrimitives
{
    public class Mesh
    {
        ...
        public void MeanCurvatureAtPoint(int i)
        {
            ...
            float Ai = 0, coTanAij = 0, coTanBij = 0;
            ...
            for (int k = 0; k < this.particleNeighbourhoods[i].Count; k++)
            {
                ...
                coTanAij = Vector.Dot(Axi, Axj) / Vector3.Cross(Axi, Axj).magnitude;
                coTanBij = Vector.Dot(Bxi, Bxj) / Vector3.Cross(Bxi, Bxj).magnitude;

                Ki += (coTanAij + coTanBij) * xixj;
